...
The Codex Run action calls `./script/build_and_run.sh`. The generated app is `dist/Peeker.app`; local builds use ad-hoc signing when `PEEKER_SIGN_IDENTITY` is not set.
