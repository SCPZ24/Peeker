...
paths=(
  ...
  "timer move"
  "timer temporary"
  "timer temporary list"
  "timer temporary get"
  "timer temporary create"
  "timer temporary update"
  "timer temporary delete"
  "timer temporary start"
  "timer config"
  "timer config get"
  "timer config set"
  "pusher"
...
usages=(
  ...
  "Usage: peeker timer temporary list"
  "Usage: peeker timer temporary get (--id <temporary-task-id> | <exact-name>)"
  "Usage: peeker timer temporary create --name <name> --target <duration> --color <preset-hex> [--expire-on-refresh <bool>]"
  "Usage: peeker timer temporary update (--id <temporary-task-id> | <exact-name>) [options]"
  "Usage: peeker timer temporary delete (--id <temporary-task-id> | <exact-name>)"
  "Usage: peeker timer temporary start (--id <temporary-task-id> | <exact-name>)"
  ...
  "Usage: peeker targetor list [--archived active|all|only]"
  "Usage: peeker targetor get (--id <target-id> | <exact-title>) [--include-archived <bool>]"
  "Usage: peeker targetor create --title <title> [options]"
  "Usage: peeker targetor update (--id <target-id> | <exact-title>) [options]"
  "Usage: peeker targetor delete (--id <target-id> | <exact-title>)"
  "Usage: peeker targetor checkin (--id <target-id> | <exact-title>)"
  "Usage: peeker targetor history (--id <target-id> | <exact-title>) [--from <rfc3339> --to <rfc3339>]"
  "Usage: peeker targetor uncheck --event-id <event-id>"
  "Usage: peeker targetor config <command>"
  "Usage: peeker targetor config get"
  "Usage: peeker targetor config set [--enabled <bool>] [--refresh-time <HH:mm>]"
)
